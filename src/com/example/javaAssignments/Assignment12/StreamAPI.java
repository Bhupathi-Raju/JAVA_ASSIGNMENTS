package com.example.javaAssignments.Assignment12;
...
public class StreamAPI {
    public static void main(String[] args) {
        ...
        Student youngMale = studentList.stream().filter(student -> student.gender.equals("Male"))
                .filter(student -> student.engDepartment.equals("Electronic")).min(Comparator.comparing(student -> student.age)).get();
